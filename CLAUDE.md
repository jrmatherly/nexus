...
- `server.client_identification.allowed_groups` must list all groups referenced in rate limit configurations
- Groups not in `allowed_groups` will be rejected with 403 Forbidden
...
limit = 1000        # Maximum tokens per user
